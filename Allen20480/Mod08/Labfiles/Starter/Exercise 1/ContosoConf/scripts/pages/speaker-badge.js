...
(function () {
    ...
    var SpeakerBadgePage = Object.inherit({
        ...
        initialize: function (element) {
            ...
            this.imageElement.addEventListener("dragover",this.handleDragOver.bind(this), false);
            this.imageElement.addEventListener("drop", this.handleDrop.bind(this), false);
        ...
        handleDrop: function (event) {
            ...
            if (this.isImageType(arquivo.type))
            {
                this.readFile(arquivo).done(this.displayImage);

            }
            else
                alert("drop uma imagem")
