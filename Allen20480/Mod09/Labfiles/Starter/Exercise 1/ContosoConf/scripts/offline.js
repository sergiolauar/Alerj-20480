(function () {
    ...
    document.body.addEventListener("ononline", showLinks);
    document.body.addEventListener("onoffline", hideLinksThatRequireOnline);

    // TODO: also handle the applicationCache error event to hide links
    ApplicationCache.addEventListener("error", hideLinksThatRequireOnline);
